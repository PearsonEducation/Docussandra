...
public class Table extends Timestamped implements Linkable, Identifiable {

  @ApiModelProperty(value = "The database's name",
      notes = "This is the database name associated with this table.", dataType = "String",
      required = true)
  @Required("Database")
  @ChildValidation
  private DatabaseReference database;

  @ApiModelProperty(value = "The table's name", notes = "This is the tables name",
      dataType = "String", required = true)
  @RegexValidation(name = "Table Name", nullable = false, pattern = Constants.NAME_PATTERN,
  ...
  /**
   * Sets the database for this table. Method is not overloaded with setDatabaseByString due to
   * weird binding issues.
   *
   * @param database
   */
  ...
  /**
   * Sets the database for this table. Method is not overloaded with setDatabaseByObject due to
   * weird binding issues.
   *
   * @param name
   */
