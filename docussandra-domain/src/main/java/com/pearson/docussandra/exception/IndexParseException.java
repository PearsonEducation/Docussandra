 ...
 * Contains more meta-data than using an IndexParseFieldException alone.
 *
...
public class IndexParseException extends IndexParseFieldException {
  ...
  public IndexParseException(IndexField field, IndexParseFieldException parent) {
    super(
        "The field: " + field.toString()
            + " could not be parsed from the document or query, it is not a valid value for the specified datatype.",
        parent.getFieldValue(), parent.getCause());
    this.field = field;
  }
