...
public class FieldNotIndexedException extends Exception
{
    ...
    {
        super("One of the following fields: [" + com.pearson.docussandra.domain.DomainUtils.join(", ", fields) + "] does not exist in any known indices (or may not be yet active). Try adding an index (if you understand the ramifications of this).");
        this.fields = fields;
    }
