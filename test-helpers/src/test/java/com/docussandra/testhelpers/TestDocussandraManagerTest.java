...
/**
 *
 * Test for the DocussandraManager. This test can not run in the same JVM as a RestExpressManager
 * instance, so it must be run ad-hoc.
 *
...
public class TestDocussandraManagerTest {
  ...
  /**
   * Test of ensureTestDocussandraRunningWithMockCassandra method, of class TestDocussandraManager.
   */
  @Test
  public void testEnsureTestDocussandraRunningWithMockCassandra() throws Exception {
    ...
    expect().statusCode(200).body("isHealthy", equalTo(true)).get("/admin/health");
  }
