...
public class UtilsTest
{
    ...
    {
        //tests error case (bad replication string) only; none of our other tests will pass if this method doesn't work, so its tested inherently by the other tests
    ...
    /**
    * Tests to check the values returned from the method setField
    * only tests negative values for now
     * */
    @Test
