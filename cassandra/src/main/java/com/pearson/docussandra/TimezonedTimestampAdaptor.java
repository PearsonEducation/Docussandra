...
public class TimezonedTimestampAdaptor extends DateAdapter
{
    ...
    {
        timestampFormats = new String[DateAdapterConstants.TIMESTAMP_INPUT_FORMATS.length + DateAdapterConstants.DATE_INPUT_FORMATS.length + 3];
        ...
        System.arraycopy(DateAdapterConstants.TIMESTAMP_INPUT_FORMATS, 0, timestampFormats, 3, DateAdapterConstants.TIMESTAMP_INPUT_FORMATS.length);
        System.arraycopy(DateAdapterConstants.DATE_INPUT_FORMATS, 0, timestampFormats, DateAdapterConstants.TIMESTAMP_INPUT_FORMATS.length + 3, DateAdapterConstants.DATE_INPUT_FORMATS.length);
