...
public class QueryService {
   ...
   */
  public QueryService(DatabaseRepository databaseRepository, TableRepository tableRepository,
   ...
   * @return A query response object containing a list of documents and some metadata about the
   *         query.
   * @throws FieldNotIndexedException If the field that was attempted to be queried on is not part
   *         of an index.
   * @throws IndexParseException If the field that was attempted to be queried on was not in a
   *         recognized format.
   */
  public QueryResponseWrapper query(String db, Query toQuery)
      throws IndexParseException, FieldNotIndexedException {
   ...
   *         recognized format.
   */
  public QueryResponseWrapper query(Query toQuery, int limit, long offset)
      throws IndexParseException, FieldNotIndexedException {
    ParsedQuery parsedQuery =
        ParsedQueryFactory.getParsedQuery(toQuery.getDatabase(), toQuery, queries.getSession());
