...
public class ParseUtils {
   ...
   * @throws IndexParseFieldException if there is no way to determine if the String should be
   *         interpreted as true or false.
   */
  public static boolean parseStringAsBoolean(String in) throws IndexParseFieldException {
    in = in.trim();
    if (in.equalsIgnoreCase("T"))// we could put this whole method in one or so line, but it is more
                                 // readable this way
    {
      return true;
   ...
   */
  public static Date parseStringAsDate(String in) throws IndexParseFieldException // TODO: come back
                                                                                  // to this and add
                                                                                  // more formats
                                                                                  // (TimezonedTimestampAdaptor)
                                                                                  // and tests
                                                                                  // https://github.com/PearsonEducation/Docussandra/issues/2
  {
   ...
   * @throws IndexParseFieldException if the String cannot be parsed as a double.
   */
   ...
   * @throws IndexParseFieldException if the String cannot be parsed as an int.
   */
   ...
   * @throws IndexParseFieldException if the String cannot be parsed as an UUID.
   */
   ...
   * @throws IndexParseFieldException if the String cannot be parsed as a long.
   */
