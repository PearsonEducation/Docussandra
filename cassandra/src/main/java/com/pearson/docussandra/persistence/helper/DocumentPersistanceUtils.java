...
/**
 * Util class for repositories (DAOs) that deal with Documents or QueryResponseWrapper types.
 *
...
public class DocumentPersistanceUtils {
   ...
   * @return a Populated QueryResponseWrapper that can be returned to a calling application or user.
   */
  public static QueryResponseWrapper parseResultSetWithLimitAndOffset(ResultSet results, int limit,
      long offset) {
