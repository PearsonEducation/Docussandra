...
public class Constants {
  ...
  /**
   * These define the route names used in naming each route definitions. These names are used to
   * retrieve URL patterns within the controllers by name to create links in responses.
   */
