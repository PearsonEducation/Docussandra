...
/**
 * Class for managing testing of RestExpress so we are not tearing down and creating new server
 * instances with every tests.
 *
 * For test use only!
 *
...
public class RestExpressManager {
   ...
   * @throws IOException
   */
  public synchronized void ensureRestExpressRunning()
   ...
   * @throws IOException
   */
  public synchronized void ensureRestExpressRunning(boolean mockCassandra)
      throws IOException, IllegalAccessException, InstantiationException {
