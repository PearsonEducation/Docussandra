...
public class TestDocussandraManager
{
     ...
     * on a external process. If false, this test instance of Docussandra will
     * hit an internal mocked version of Cassandra instead; no data will be
     ...
     * RestExpress. Will override any existing seeds.
     *
     * @throws IOException
     */
    public synchronized void ensureTestDocussandraRunning(String cassandraSeeds) throws IOException, IllegalAccessException, InstantiationException
    {
        if (restExpressRunning == false)
        {
            LOGGER.info("Starting RestExpress server...");
