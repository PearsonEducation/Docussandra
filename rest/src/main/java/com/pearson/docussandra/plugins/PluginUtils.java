...
public class PluginUtils
{
    ...
    /**
     * Gets file references to any plugin jars in the users home directory. Will
     * return any file in the home directory that ends with ".jar" and starts
     * with "plugin".
     *
    ...
    public static File[] getPluginJars()
    {
        ...
        logger.info("Searching home directory (" + homeDir.getAbsolutePath() + ") for plugin modules...");
