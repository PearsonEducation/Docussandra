...
public abstract class AbstractIndexControllerTest
{
    ...
    public void beforeTest()
    {
        ...
        RestAssured.basePath = "/databases/" + testDb.name() + "/tables/" + testTable.name() + "/indexes";
    }
