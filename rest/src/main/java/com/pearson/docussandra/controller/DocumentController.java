...
public class DocumentController {
   ...
   */
  @ApiOperation(value = "create document", notes = "This method creates a document",
  ...
  public Document create(Request request, Response response) {
    ...
    try {
      ...
      TokenResolver resolver =
          HyperExpress.bind(Constants.Url.DOCUMENT_ID, saved.getUuid().toString());
  ...
  public Document read(Request request, Response response) {
    ...
    Document document =
        documentService.read(database, table, new Identifier(database, table, UUID.fromString(id)));
