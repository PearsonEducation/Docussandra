...
public class IndexStatusController {
   ...
   * @return
   */
  @ApiOperation(value = "get the index status", notes = " ", response = IndexCreatedEvent.class)
  @ApiModelRequest(model = IndexCreatedEvent.class, required = true,
   ...
   * @return
   */
  @ApiOperation(value = "get all the index statues", notes = " ",
