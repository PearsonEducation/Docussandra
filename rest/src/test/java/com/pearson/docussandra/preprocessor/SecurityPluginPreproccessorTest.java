...
public class SecurityPluginPreproccessorTest {
  ...
  public void testProcess() {
    ...
    // check to see that our test plugins actually ran like we wanted them to (these properties are
    // set in the test plugin)
  ...
  /**
   * Test of extractHeadersFromRequest method, of class SecurityPluginPreproccessor.
   */
  @Test
  public void testExtractHeadersFromRequest() {
    ...
    HashMap<String, List<String>> result =
        SecurityPluginPreproccessor.extractHeadersFromRequest(request);
  ...
  private Request createTestRequest() {
    Request r = new Request(
        new DefaultFullHttpRequest(HttpVersion.HTTP_1_0, HttpMethod.GET, "/test/path/here"),
        new RouteResolver(null));
