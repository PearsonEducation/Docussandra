...
public abstract class SecurityPlugin implements Plugin {
  ...
  public enum HttpMethod {
    ...
    /**
     * Friendly method for getting the HttpMethod based off of a String. Cleans up the string so it
     * should work regardless of case or extra whitespace.
     *
  ...
  /**
   * Method that performs a validation based on the passed in headers. Should throw a
   * PermissionDeniedException if the client is not authorized.
   *
   ...
   */
  public abstract void doValidate(HashMap<String, List<String>> headers, String requestedPath,
      HttpMethod method) throws PermissionDeniedException;
}
