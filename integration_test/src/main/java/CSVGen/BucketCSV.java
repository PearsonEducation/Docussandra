...
public class BucketCSV {
  ...
  public static void generateIntegerBucketsAndTest() throws Exception {
    ...
    for (Long l : PrimaryIndexBucketLocatorImpl.getBUCKETS()[FieldDataType.INTEGER
        .getIndexForDataType()]) {
      sb.append(l).append(",");
    }
  ...
  public static void generateStringBucketsAndTest() throws Exception {
    ...
    Utils.writeFile(res.printDistAsCSV(),
        "FourthousandYearStringWith" + numBuckets + "buckets.csv");
    Utils.writeFile(res.printDistStatsAsCSV(),
        "FourthousandYearStringStatsWith" + numBuckets + "buckets.csv");
    StringBuilder sb = new StringBuilder();
    for (Long l : PrimaryIndexBucketLocatorImpl.getBUCKETS()[FieldDataType.TEXT
        .getIndexForDataType()]) {
      sb.append(l).append(",");
    }
  ...
  public static RunStats delegateGetBucketForString(int buckets)
      throws FileNotFoundException, Exception {
    Long startTime = System.currentTimeMillis();
    PrimaryIndexBucketGeneratorImpl ibg =
        new PrimaryIndexBucketGeneratorImpl(FieldDataType.TEXT, buckets);
    PrimaryIndexBucketLocatorImpl locator = new PrimaryIndexBucketLocatorImpl(ibg.generateBuckets(),
  ...
  public static void generateDoubleBucketsAndTest() throws Exception {
    ...
    StringBuilder sb = new StringBuilder();
    for (Long l : PrimaryIndexBucketLocatorImpl.getBUCKETS()[FieldDataType.DOUBLE
        .getIndexForDataType()]) {
      sb.append(l).append(",");
    }
  ...
  public static void generateLongBucketsAndTest() throws Exception {
    ...
    StringBuilder sb = new StringBuilder();
    for (Long l : PrimaryIndexBucketLocatorImpl.getBUCKETS()[FieldDataType.LONG
        .getIndexForDataType()]) {
      sb.append(l).append(",");
    }
  ...
  public static void generateTimepointBucketsAndTest() throws Exception {
    ...
    Utils.writeFile(res.printDistAsCSV(),
        "FourthousandYearTimepointWith" + numBuckets + "buckets.csv");
    Utils.writeFile(res.printDistStatsAsCSV(),
        "FourthousandYearTimepointStatsWith" + numBuckets + "buckets.csv");
    ...
    Utils.writeFile(res.printDistStatsAsCSV(),
        "recentTimepointStatsWith" + numBuckets + "buckets.csv");
  ...
  public static void generateBinaryBucketsAndTest() throws Exception {
    ...
    StringBuilder sb = new StringBuilder();
    for (Long l : PrimaryIndexBucketLocatorImpl.getBUCKETS()[FieldDataType.BINARY
        .getIndexForDataType()]) {
      sb.append(l).append(",");
    }
  ...
  public static RunStats delegateGetBucketForFourthousandYearTimepoint(int buckets)
      throws ParseException, IndexParseFieldException, Exception {
    long startTime = System.currentTimeMillis();
    PrimaryIndexBucketGeneratorImpl sbg =
        new PrimaryIndexBucketGeneratorImpl(FieldDataType.TIMEPOINT, buckets);
    PrimaryIndexBucketLocatorImpl locator = new PrimaryIndexBucketLocatorImpl(null, null, null,
        null, null, null, null, null, sbg.generateAndWrite());
    ...
    SummaryStatistics stats = new SummaryStatistics();
    Date date = null;
    for (int i = 0; i < 1460000 * 2; i++) // There are approximately 1460000 days from 0015 year to
                                          // 4015 year
    {
    ...
    long runTime = System.currentTimeMillis() - startTime;
    RunStats runStats =
        new RunStats("BucketForFourthousandYearDates", FieldDataType.TIMEPOINT, runTime, stats, hm);
    logger.debug(runStats.toString());
    return runStats;
  }

  public static RunStats delegateGetBucketForFourthousandYearDates(int buckets)
      throws ParseException, IndexParseFieldException, Exception {
    long startTime = System.currentTimeMillis();
    PrimaryIndexBucketGeneratorImpl sbg =
    ...
    PrimaryIndexBucketLocatorImpl locator = new PrimaryIndexBucketLocatorImpl(null,
        sbg.generateAndWrite(), null, null, null, null, null, null, null);
  ...
  // {
  // List<Long> bucketList =
  // SimpleIndexBucketLocatorImpl.getBUCKETS()[FieldDataType.DATE_TIME.getIndexForDataType()];
  // StringBuilder sb = new StringBuilder();
  ...
  public static RunStats delegateGetBucketForBoolean(int buckets) throws Exception {
    Long startTime = System.currentTimeMillis();
    PrimaryIndexBucketGeneratorImpl ibg =
        new PrimaryIndexBucketGeneratorImpl(FieldDataType.BOOLEAN, buckets);
    PrimaryIndexBucketLocatorImpl locator = new PrimaryIndexBucketLocatorImpl(null, null, null,
        null, ibg.generateBuckets(), null, null, null, null);
  ...
  public static RunStats delegateGetBucketForUuids(int buckets) throws Exception {
    Long startTime = System.currentTimeMillis();
    PrimaryIndexBucketGeneratorImpl ibg =
        new PrimaryIndexBucketGeneratorImpl(FieldDataType.UUID, buckets);
    PrimaryIndexBucketLocatorImpl locator = new PrimaryIndexBucketLocatorImpl(null, null, null,
        null, null, ibg.generateBuckets(), null, null, null);
  ...
  public static RunStats delegateGetBucketForIntegers(int buckets) throws Exception {
    Long startTime = System.currentTimeMillis();
    PrimaryIndexBucketGeneratorImpl ibg =
        new PrimaryIndexBucketGeneratorImpl(FieldDataType.INTEGER, buckets);
    PrimaryIndexBucketLocatorImpl locator = new PrimaryIndexBucketLocatorImpl(null, null, null,
        ibg.generateBuckets(), null, null, null, null, null);
    logger.debug("test to getBucket for the bucket distribution");
    HashMap<Long, List<Object>> hm = new HashMap<>();
    SummaryStatistics stats = new SummaryStatistics();
    ...
    Long runTime = System.currentTimeMillis() - startTime;
    RunStats runStats =
        new RunStats("BucketForIntegers", FieldDataType.INTEGER, runTime, stats, hm);
    logger.debug(runStats.toString());
    return runStats;
  }
  ...
  public static RunStats delegateGetBucketForBinaryBase64(int buckets) throws Exception {
    Long startTime = System.currentTimeMillis();
    PrimaryIndexBucketGeneratorImpl ibg =
        new PrimaryIndexBucketGeneratorImpl(FieldDataType.BINARY, buckets);
    PrimaryIndexBucketLocatorImpl locator = new PrimaryIndexBucketLocatorImpl(null, null, null,
        null, null, null, ibg.generateBuckets(), null, null);
    ...
    Long runTime = System.currentTimeMillis() - startTime;
    RunStats runStats =
        new RunStats("BucketForBinaryBase64", FieldDataType.BINARY, runTime, stats, hm);
    logger.debug(runStats.toString());
    return runStats;
  }
  ...
  public static RunStats delegateGetBucketForLong(int buckets) throws Exception {
    Long startTime = System.currentTimeMillis();
    PrimaryIndexBucketGeneratorImpl ibg =
        new PrimaryIndexBucketGeneratorImpl(FieldDataType.LONG, buckets);
    PrimaryIndexBucketLocatorImpl locator = new PrimaryIndexBucketLocatorImpl(null, null, null,
        null, null, null, null, ibg.generateBuckets(), null);
  ...
  public static RunStats delegateGetBucketForGreekString(int buckets) throws Exception {
    ...
    try {
      ...
      try {
        ...
        Long runTime = System.currentTimeMillis() - startTime;
        RunStats runStats =
            new RunStats("BucketForGreekString", FieldDataType.TEXT, runTime, stats, hm);
        logger.debug(runStats.toString());
        return runStats;
      } finally {
        br.close();
  ...
  public static RunStats delegateGetBucketForDouble(int buckets) throws Exception {
    Long startTime = System.currentTimeMillis();
    PrimaryIndexBucketGeneratorImpl ibg =
        new PrimaryIndexBucketGeneratorImpl(FieldDataType.DOUBLE, buckets);
    PrimaryIndexBucketLocatorImpl locator = new PrimaryIndexBucketLocatorImpl(null, null,
        ibg.generateBuckets(), null, null, null, null, null, null);
    ...
    Random r = new Random();
    for (int i = 0; i < 20000; i++) {
      // double randomDouble = (-1) * Double.MIN_NORMAL + r.nextDouble() * Double.MAX_VALUE *
      // Double.MAX_VALUE;
  ...
  public static RunStats delegateGetBucketPerRecentDateForMinute(int buckets, FieldDataType type)
      throws Exception {
    long startTime = System.currentTimeMillis();
    ...
    PrimaryIndexBucketLocatorImpl locator = new PrimaryIndexBucketLocatorImpl(null, bucketList,
        null, null, null, null, null, null, bucketList);
