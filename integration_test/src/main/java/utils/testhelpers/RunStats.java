...
/**
 * Class for storing the results of a run. Just a test helper class, so javadoc
 * is light.
 */
...
//        }
    public RunStats(String testType, FieldDataType dataType, long runtime, SummaryStatistics stats, HashMap<Long, List<Object>> bucketMap)
    {
    ...
    {
        this.bucketSize = PrimaryIndexBucketLocatorImpl.getBUCKETS()[dataType.getIndexForDataType()].size();
    }
